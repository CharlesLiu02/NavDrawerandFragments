...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pythag) {
            // constructing a PythagFragment
            newFragment = new PythagFragment();
        }
        ...
        if(newFragment != null){
            ...
            //set the transition, change the backstack, etc.
            fm.beginTransaction().replace(R.id.container_main, newFragment).commit();
        }
